...
public class SingleNumber {
    public static void main(String[] args) {
        ...
        System.out.println("Number that appears only once is: " + sn2.singleNumber(a));
    }
...
class SingleNumber2 {
    ...
    public int singleNumber(int[] A) {
        int result = 0;
        int[] bits = new int[32];
        //because we need to construct the number based on bit,
        // we make the outer loop iterating each bit and inner one for each element in A
        for (int i = 0; i < 32; i++) {
